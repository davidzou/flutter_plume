...
///      return DegreeAngleRotationTransition(
...
///    child: Container(
///      key: ValueKey(item),
///      child: _buildWidget(context, item),
///    ),
///  )
///  </code>
///
class DegreeAngleRotationTransition extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (direction == TextDirection.rtl) {
      // 从右至左
      _alignment = turns.status == AnimationStatus.forward ? Alignment.bottomRight : Alignment.bottomLeft;
      ...
      // 从左到右
      _alignment = turns.status == AnimationStatus.forward ? Alignment.bottomLeft : Alignment.bottomRight;
