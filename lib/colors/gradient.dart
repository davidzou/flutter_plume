...
List gradients = const [
  ...
  Memariani, Amin, Harvey, Neuromancer, AzurLane, WitchingHour, Flare, Metapolis, KyooPal, KyeMeh,
  KyooTah, ByDesign, UltraVoilet, BurningOrange, Wiretap, SummerDog, Rastafari, SinCityRed, CitrusPeel, BlueRaspberry,
  Margo, Magic, EveningNight, Vanusa, Shifty, eXpresso, SlightOceanView, PureLust, MoonPurple, RedSunset,
  Shifter, WeddingDayBlues, SandToBlue, Quepal, PunYeta, SublimeLight, Bighead, TaranTado, RelaxingRed, Lawrencium,
  Ohhappiness, Delicate, Selenium, Sulphur, PinkFlavour, RainbowBlue, OrangeFun, DigitalWater, Lithium, Argon,
  Hydrogen, Zinc, VelvetSun, KingYna, Summer, OrangeCoral, Purpink, Dull, KimobyIsTheNewBlue, BrokenHearts,
  Subu, Socialive, CrimsonTide, Telegram, Terminal, Scooter, Alive, Relay, Meridian, CompareNow,
  Mello,
];
